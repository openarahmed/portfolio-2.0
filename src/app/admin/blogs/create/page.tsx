    ...
    <div className="w-full max-w-7xl mx-auto pb-20">
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4 mt-8">
        <div>
          <Link
            href="/admin/blogs"
            className="inline-flex items-center gap-2 text-gray-500 hover:text-white transition-colors mb-4 text-sm font-bold uppercase tracking-wider group"
          >
            <ArrowLeft
              size={16}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-3 group">
              <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1 group-focus-within:text-blue-400 transition-colors">
                Blog Title
              </label>
            ...
            <div className="space-y-3 group">
              <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1 group-focus-within:text-purple-400 transition-colors">
                Slug
              </label>
              <div className="relative">
                <LinkIcon
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-3 group">
              <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1 group-focus-within:text-pink-400 transition-colors">
                Tags
              </label>
              <div className="relative">
                <Tag
          ...
          <div className="space-y-3 group">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1 group-focus-within:text-indigo-400 transition-colors">
              Short Excerpt
            </label>
            <div className="relative">
              <Layout
