...
export default async function BlogPage() {
  ...
  return (
    // FIX: Tightened pt-16 to pt-12 to reduce empty top space
    <section className="relative min-h-screen w-full bg-[#050511] overflow-hidden pt-12 pb-8 px-4 sm:px-6 font-sans">
      {/* Background Ambience */}
