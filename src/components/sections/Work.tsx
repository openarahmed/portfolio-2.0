...
const workSections = [
  ...
  // 2. MOBILE APP SOLUTIONS
  {
    ...
    largeProject: {
      ...
      downloadUrl:
        "https://drive.google.com/file/d/1DFMRWKJd9BfeoAJnJo52DyZmUxFZjIJt/view?usp=sharing",
    },
    smallProjects: [
      {
        title: "Routina",
        ...
        downloadUrl:
          "https://drive.google.com/file/d/1KNxuCzjleUXnRJoY9H34MOq6rZQcb856/view?usp=sharing",
      },
      {
        title: "FitMat Meal",
        ...
        tags: ["React Native", "Expo", "Firebase", "Firestore"],
        image:
          "https://i.postimg.cc/vmqNZ1dT/mobile_app_image_for_fitmat_meal.png",
        downloadUrl: "#",
      },
    ],
  },
...
export default function Work() {
  ...
  return (
    <section
      id="work"
      className="relative w-full py-[3rem] lg:py-[clamp(6rem,10vh,10rem)] bg-[#050511] overflow-hidden space-y-12 lg:space-y-32"
    >
            ...
            >
              ...
              <div className="mb-4 sm:mb-8 flex flex-col md:flex-row md:items-end justify-between gap-1 border-b border-white/5 pb-2 md:pb-4">
                ...
                <div className="text-[10px] sm:text-xs font-mono text-gray-500 uppercase hidden md:block">
                  0{index + 1} / 0{workSections.length}
                </div>
              </div>
      ...
      >
        ...
        <div className="w-full h-full rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-[#0b0f19] flex items-center justify-center">
          {data.type === "video" ? (
            ...
            <div className="relative w-full h-auto max-h-[80vh] flex items-center justify-center p-2">
              <img
                src={data.image}
                alt={data.title}
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">{data.desc}</p>
        </div>
      </div>
    </div>
  );
    ...
    <>
      ...
      >
        {items.map((proj, idx) => (
          <div
            key={idx}
            className="snap-center w-[85vw] flex-shrink-0 h-[280px]"
          >
            <LargeCard
              project={proj}
              isMobile={true}
...
function LargeCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 z-30 flex gap-3 lg:hidden">
        {project.githubUrl && (
          <button
            ...
            className="p-2 rounded-full bg-black/50 border border-white/10 text-white backdrop-blur-md active:bg-white/20 transition-colors"
          >
            <Github size={18} />
          </button>
        )}
      ...
      {/* --- VIDEO PLAY BUTTON WITH LIVE ANIMATION --- */}
      {isVideo && (
      ...
      {isImageModal && (
        <div className="absolute top-4 right-4 z-20 p-2 rounded-full bg-black/40 backdrop-blur-md text-white/80 border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity">
          <ZoomIn size={20} />
        </div>
      )}
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 lg:p-10 z-20">
        <div className="flex justify-between items-end mb-2">
          <div className="w-full">
            <h3 className="text-xl lg:text-3xl font-black text-white drop-shadow-md uppercase tracking-tight leading-none mb-2">
              {project.title}
            </h3>
            <p className="text-gray-300 text-xs lg:text-sm font-medium leading-relaxed line-clamp-2">
              {project.desc}
            </p>
          </div>
...
function SmallCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 z-30 flex gap-2 lg:hidden">
        {project.githubUrl && (
          <button
            ...
            className="p-1.5 rounded-full bg-black/50 border border-white/10 text-white backdrop-blur-md active:bg-white/20 transition-colors"
          >
            <Github size={16} />
          </button>
        )}
      ...
      <div
        className={`absolute inset-0 z-20 p-6 lg:p-8 flex flex-col justify-end items-start`}
      >
        <div className="w-full flex justify-between items-end mb-1">
          <div className="w-full">
            <h3 className="text-lg lg:text-2xl font-black text-white drop-shadow-md uppercase tracking-tight leading-none mb-1">
              {project.title}
            </h3>
            <p className="text-gray-300 text-[10px] lg:text-xs font-medium leading-relaxed line-clamp-2 opacity-80">
              {project.desc}
            </p>
          </div>
