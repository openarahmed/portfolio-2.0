...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="relative w-full pt-16 pb-32 lg:pt-32 lg:pb-48 bg-[#050511] overflow-hidden flex flex-col items-center justify-center"
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 xl:px-12 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 mb-8">
          ...
          <SocialLink
            href="https://www.linkedin.com/in/devshakil/"
            label="LinkedIn"
          />
          <SocialLink
