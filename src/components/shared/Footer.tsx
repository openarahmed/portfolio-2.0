...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full pt-16 pb-32 lg:pt-32 lg:pb-48 bg-[#050511] overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <div className="mb-6 lg:mb-8">
            ...
            <span className="text-[clamp(3rem,7vw,9rem)] text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-200 to-gray-500 drop-shadow-xl inline-block">
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 bg-black/80 backdrop-blur-sm animate-fade-in">
            {/* MODAL CONTAINER:
                ...
                - sm:max-w-md: Max width of 448px on desktop (reduced from max-w-lg which was 512px)
            */}
            <div className="relative w-full sm:max-w-md bg-[#0b0f19] border border-white/10 rounded-[24px] sm:rounded-[30px] p-6 sm:p-8 shadow-[0_0_80px_-20px_rgba(37,99,235,0.4)] animate-scale-up overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <form className="space-y-5 sm:space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button className="w-full py-3 sm:py-4 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold text-sm sm:text-base tracking-wide hover:from-blue-500 hover:to-blue-400 transition-all shadow-[0_0_30px_rgba(37,99,235,0.3)] hover:shadow-[0_0_40px_rgba(37,99,235,0.5)] flex items-center justify-center gap-2 mt-2 group transform active:scale-[0.98]">
